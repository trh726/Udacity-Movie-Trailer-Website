...
class Movie(object):
    ...
    def __init__(self, movie_title, movie_storyline, poster_image, trailer_youtube):
        ...
        #creates an instance variable poster_image_url from the third argument - used by fresh_tomatoes
        self.poster_image_url = poster_image
        #creates an instance variable trailer_youtube_url from the fourth argument - used by fresh_tomatoes
